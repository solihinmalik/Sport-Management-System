    ...
    void status_payment(double d) 
    {
        ...
        do
        {
            ...
            if (ch == 'Y' || ch == 'y')
            {
                ...
                cout << "AMOUNT THAT NEED TO BE PAID: " << dissTotal << endl;  
            }
            else
            {
                cout << "AMOUNT THAT NEED TO BE PAID: " << d << endl;
            }
                ...
                {
                    cout << "UNPAID " << endl
                        << "YOU NEED TO ENTER MORE MONEY " << endl;
                    cout << "AMOUNT YOU PAY: ";
                    cin >> amount2;
    ...
    public:
        ...
        { 
            ...
            do
            {
                ...
                cout << "DO YOU WANT TO CONTINUE ? IF YES PRESSS <1> ";
                cin >> cont;
        ...
        void displayInvoice (int sport_type)
        {
            if(sport_type == 1) // Badminton
            {
                ...
                cout << "\nTOTAL PAYMENT FOR EQUIPMENT  : " << totalAll  << endl ;
