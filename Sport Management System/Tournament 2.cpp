...
class Time {
    ...
    public:
        ...
        void get_StartTime(){   // Assume start time
            ...
            cout << "Notes : Use 12-hour system format for both start & end time\n"
            ...
            if (status == "AM")
                cout << "START TIME -> " << hour << ":" << minute << " AM" << endl;
            else
                cout << "START TIME -> " << hour << ":" << minute << " PM" << endl;
        ...
        void get_EndTime(){   // Assume End time
            ...
            if (status == "AM")
                cout << "END TIME -> " << hour << ":" << minute << " AM" << endl;
            else
                cout << "END TIME -> " << hour << ":" << minute << " PM" << endl;
     ...
     do
    {
        ...
        if(choiceMain == 1)
        {
            ...
            if(p1.getType()==1)//Badminton
            {
                ...
                p1.displayVenue();
                cout<<endl;
                 a.getDatestart();  //input date for badminton
            }
            else //Futsal
            {
                ...
                p1.displayVenue();
                cout<<endl;
                 a.getDatestart();  //input date for futsal
            }
